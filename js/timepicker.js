 ...
 * add functiong _gotoNow() , modified function _gotoday()
 * 增加“现在” currentText2 line44，修改“今天” line1660
 * 点“完成”默认隐藏，添加iframe刷新方法 line1566
 *
 * 2013-11-27 modified by liz
 * 拖动支持（控件头部）
 * */
(function( $, undefined ) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _generateHTML: function(inst) {
            ...
            buttonPanel = (showButtonPanel) ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (isRTL ? controls : "") +
                (this._isInRange(inst, gotoDate) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>"+currentText+"</button><button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='now' data-event='click'" +
                    ">" + currentText2 + "</button>" : "") + (isRTL ? "" : controls) + "</div>" : "";
...
// 代理 mousedown 事件触发对话框拖动
    $(document).bind('mousedown', function (event) {
        ...
        if (target !== "ui-datepicker-title") return;
        dragInit(event);
        // 防止firefox与chrome滚屏
        return false;
